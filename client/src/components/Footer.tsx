...
export default function Footer() {
  return (
    ...
    <footer className='bg-neutral-800'>
        <div className='mx-auto w-full max-w-screen-xl px-4 sm:p-32 py-6 lg:py-8'>
            <div className='mb-6 md:mb-6'>
                <a href="/" className='flex items-center'>
                    <img src={logo} className='h-8 mr-3' alt="logo" />
                    <span className='self-center text-2xl font-semibold whitespace-nowrap text-[#d92527]'>AFIA</span>
                    <span className='self-center text-2xl font-semibold whitespace-nowrap text-[#4650c0] ml-1'>DOC</span>
                </a>
            </div>
            <div className='md:flex md:justify-between'>
                <div className='grid grid-cols-2 gap-8 px-2 sm:px-0 sm:gap-6 sm:grid-cols-3'>
                    <div>
                        <h2 className='mb-4 text-sm font-semibold text-white uppercase'>Site Map</h2>
                        <ul className='text-white'>
                            ...
                            <li className='mb-2'>
                                <a href="https://flowbite.com/" className='hover:underline'>Syarat & Ketentuan</a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <hr className='my-6 mx-2 text-white sm:mx-auto lg:my-8' />
            <div className='px-2 sm:px-0 sm:flex sm:items-center sm:justify-between'>
                <span className='text-sm text-white sm:text-center'>© 2023 <a href="https://flowbite.com/" className='hover:underline'>AFIADOC</a>. All Rights Reserved.</span>
