...
const TableDataGrid = ({ data, columns }) => {
    ...
    return (
        ...
        >
            <DataGrid rows={data} columns={columns} pageSize={10} disableColumnMenu checkboxSelection={false} disableRowSelectionOnClick columnBuffer={columns.length} autoHeight />
        </div>
    )
}
