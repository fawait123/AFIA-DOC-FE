...
const AddDoctor = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:8000/api/dokter/store', {
                method: 'POST',
                headers: {
    ...
    return (
        <Admin>
            ...
            >
                <Typography variant={{ xs: "h7", md: "h6" }} sx={{ fontWeight: { xs: 500, md: 600 } }}>
                    Add new doctor
                </Typography>
            </Box>
            <Box sx={{ width: 1, display: 'flex', justifyContent: 'center', bgcolor: '#ffffff', paddingX: 2, paddingY: 4 }}>
                <form style={{ width: '100%' }} onSubmit={handleSubmit}>
                <Grid container  columns={{ xs: 1, md: 2 }} spacing={1} sx={{ width: 1 }} rowSpacing={2}>
                    <Grid item xs={1}>
                        <Grid container sx={{ width: 1 }} columns={{ xs:1, md: 2 }} spacing={1} rowSpacing={3}>
                            <Grid item xs={1}>
                                <TextField
                                    label="Nama"
                                ...
                                <Grid container columns={2} spacing={1}>
                                    <Grid item xs={1}>
                                        <TextField
                                            ...
                                            placeholder="S.Ked"
                                            fullWidth
                                            onChange={(e) => setInitDeg(e.target.value)}
                                        />                                        
                                    </Grid>
                                    <Grid item xs={1}>
                                        <TextField
                                            ...
                                            placeholder="Sp.KK"
                                            fullWidth
                                            onChange={(e) => setFinalDeg(e.target.value)}
                                        />                                        
                                    </Grid>
                                </Grid>
                            </Grid>
                            ...
                            <Grid item xs={1}>
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DatePicker label="Tanggal Lahir" slotProps={{ textField: { fullWidth: true } }} onChange={(date) => setBirthday(date)} />
                    ...
                    <Grid item xs={1}>
                        <Grid container columns={2} spacing={1} rowSpacing={3}>
                            <Grid item xs={2} md={1}>
                                <FormControl sx={{ width: 1 }} >
                            ...
                            <Grid item xs={2}>
                                ...
                                <div {...getRootProps()} style={dropzoneStyles}>
                                    <input {...getInputProps()} />
                                    {previewImage ? (
                                    <img src={previewImage} alt="Preview" style={previewImageStyles} />
                                    ) : (
                                    isDragActive ? (
                    ...
                    <Grid item xs={2}>
                        <Button variant="contained" type="submit" color="error" sx={{ width: 1, padding: 1 }}>
